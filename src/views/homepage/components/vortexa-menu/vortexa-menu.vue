<template>
  ...
  >
    ...
    <el-sub-menu index="4">
      ...
      <el-menu-item-group>
        <el-menu-item index="4-1" :class="verticalMode" @click="goTo('/script_node')">
          <vortexa-icon name="cluster" size="19"/>
          <span>Node Manage</span>
        </el-menu-item>
        <el-menu-item  index="4-2" :class="verticalMode" @click="goTo('/script')">
    ...
    <el-menu-item index="5" :class="verticalMode" @click="goTo('/setting')">
      <vortexa-icon name="account" size="19"/>
      <span>User</span>
    </el-menu-item>

    <el-menu-item index="6" :class="verticalMode" @click="goTo('/setting')">
      <el-icon>
        <Setting/>
      </el-icon>
      <span>Setting</span>
...
import {House, User, Setting, Compass} from '@element-plus/icons-vue'
